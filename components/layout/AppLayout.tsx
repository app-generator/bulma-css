...
const AppLayout = ({ title, desc, children }) => {
  return (
    <div className="relative has-background-white">
      <Meta pageTitle={title} description={desc} />
      <div className="mx-auto h-full pr-4 pl-4">
        <div className="relative z-10 pb-3 has-background-white h-full">
          <Header
            items={menuEntry}
            ddmMode={false}
            hideHelp={false}
          ...
          <main className="container is-max-widescreen mt-4 mb-6">
            {children}
          </main>
        </div>
      </div>
