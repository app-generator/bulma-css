...
const theme = {
  dark: {
    ...
    job: "has-text-white-ter",
    desc: "has-text-white-ter",
    icon: "has-text-white-ter",
  },
  light: {
...
const SimpleTeam = (props: Props) => {
  ...
  return (
    <div className={`box ${theme[mode].background}`}>
      ...
      <div className="has-text-centereder">
        <p className={`is-size-4 ${theme[mode].title}`}>Patrick Sebastien</p>
        <p className={`is-size-5 ${theme[mode].job} has-text-weight-light`}>
          Developpeur
        </p>
        <p
          className={`is-size-6 ${theme[mode].desc} py-4 has-text-weight-light`}
        >
      ...
      <div
        className={`pt-4 is-flex is-align-items-center is-justify-content-space-between`}
      >
        <a href="#">
          <svg
            width="30"
            height="30"
            fill="currentColor"
            className={`is-size-5 ${theme[mode].icon}`}
